...
class CardAnimation {
  ...
  void update(double dx, double dy, bool inverseAngel) {
    ...
    total = left + top;
    updateAngle(inverseAngel);
    updateScale();
    updateDifference(dx, dy);
  }
  ...
  void updateDifference(double dx, double dy) {
  ...
  void animate(BuildContext context, CardSwipeDirection direction){
    return switch(direction){
      CardSwipeDirection.left => animatedHorizontally(context, false),
      CardSwipeDirection.right => animatedHorizontally(context, true),
      CardSwipeDirection.none => null,
    };
  }

  void animatedHorizontally(BuildContext context, bool isToRight){
